...
// Display menu item's title by using a Toast.
        if (id == R.id.action_edit) {
            Intent in = new Intent(WantedActivity.this,SearchInfo.class);
            in.putExtra("CrimeCategory", id);
            startActivity(in);

            return true;
        }else if(id == R.id.action_report){
            Intent in = new Intent(WantedActivity.this,AllReports.class);
            startActivity(in);
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1) {
                View rootView = inflater.inflate(R.layout.fragment_tabbedwanted, container, false);
                return rootView;
            }else if(getArguments().getInt(ARG_SECTION_NUMBER)==2) {
                View rootView = inflater.inflate(R.layout.fragment_tabbed_mwanted, container, false);
                return rootView;
            }else{
